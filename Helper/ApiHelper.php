...
namespace Onfire\Paymark\Helper;

use Magento\Framework\Exception\LocalizedException;
use Magento\Framework\App\Helper\AbstractHelper;
use Magento\Framework\App\Helper\Context;
use Onfire\Paymark\Model\Adminhtml\Source\PaymentAction;

class ApiHelper extends AbstractHelper
{

    /**
     * @var \Onfire\Paymark\Helper\Helper
     */
    private $_helper;

    /**
     * @var \Onfire\Paymark\Model\PaymarkAPI
     */
    private $_paymarkApi;
    ...
    public function __construct(Context $context)
    {
        ...
        $this->_helper = $this->_objectManager->create("\Onfire\Paymark\Helper\Helper");

        $this->_paymarkApi = $this->_objectManager->create("\Onfire\Paymark\Model\PaymarkAPI");
    }
        ...
        if($transactions && count($transactions) > 0) {
            ...
            foreach($transactions as $transaction) {
                if(
                    ...
                    $transaction->status == \Onfire\Paymark\Helper\Helper::PAYMENT_SUCCESS
                ) {
